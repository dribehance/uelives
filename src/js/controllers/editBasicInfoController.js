angular.module("Uelives").controller("editBasicInfoController", function($scope, $route, $rootScope, $timeout, $location, $filter, weixinServices, userServices, errorServices, toastServices, localStorageService, config) {
    $scope.input = {
        translate_year: '',
        options: {}
    };
